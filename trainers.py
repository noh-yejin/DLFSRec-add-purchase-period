    ...
    def iteration(self, epoch, dataloader, full_sort=False, train=True):
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                # inputs_id: torch.Size([256, 50], inputs_cxt=torch.Size([256, 50, 6]), inputs_period: torch.Size([256, 50])

                sequence_mean_output, sequence_cov_output = self.model(inputs_id, inputs_cxt) #size: [256,50,64]
